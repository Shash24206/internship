...
const CodeOfEthics = () => {
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative">
        <img
          src="/assets/code-of-ethics/banner.jpg"
          alt="Code of Ethics Banner"
          className="w-full h-[300px] object-cover"
        />
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
          <h1 className="text-white text-4xl font-bold">CODE OF ETHICS</h1>
        </div>
      </section>

      <section className="flex flex-col lg:flex-row h-auto lg:h-[calc(100vh-300px)] bg-gradient-to-br from-red-50 to-white px-4 py-10 gap-8 max-w-7xl mx-auto">
  {/* Sidebar */}
  <div className="lg:w-1/4 max-h-full overflow-y-auto space-y-2 sticky lg:top-20 h-fit lg:h-full">
  ...
  {/* Content */}
  <div className="lg:w-3/4 max-h-full overflow-y-auto space-y-6 pr-2">
    {ethicsData.map((item, index) => (
      <div
        key={index}
        ref={(el) => (sectionsRef.current[index] = el)}
        className="bg-white rounded-xl shadow p-6 border-l-4 border-blue-500 scroll-mt-28"
      >
