...
const AboutUs = () => {
  ...
  >
    {[
      {
        src: "person1.jpg",
        name: "Dr. Dev L Mohanty",
        info: "Chairman",
        desc: "Holds Degree in Electrical Engineering, Masters in Business Administration, and Doctor of Philosophy in Entrepreneurship. Served on board General Cargo vessels for over ten years."
      },
      {
        src: "person2.jpg",
        name: "Mrs. Harapriya Mohanty",
        info: "Director",
        desc: ""
      },
      {
        src: "person3.jpg",
        name: "Mr. Ashutosh Chandra Mohanty",
        info: "Director",
        desc: "Has over eight years experience in Management and execution of ship repairing projects, infrastructure development, man power planning, and business promotion."
      },
      {
        src: "person4.jpg",
        name: "Mr. Alex M Jacob",
        info: "Technical Superintendent",
        desc: "Having over 25 years' experience in overhauling, refurbishing Engines, Pumps, Motors and ancillary mechanical equipment on board vessels."
      },
      {
        src: "person5.jpg",
        name: "Capt. V.S.T. Fernandes",
        info: "Marine Superintendent",
        desc: "Master Mariner with over 15 years sailing experience, and over eight years in Crew Management, and administration."
      }
    ].map((person, i) => (
      <SwiperSlide key={i}>
        <div className="flex flex-col items-center">
          <div className="w-full h-64 flex items-center justify-center overflow-hidden rounded-xl shadow-md bg-white">
            <img
              src={person.src}
              alt={person.name}
          ...
          <div className="mt-3 bg-white rounded-lg shadow p-3 w-full text-center">
            <div className="font-semibold text-blue-900">{person.name}</div>
            <div className="text-sm text-gray-600">{person.info}</div>
            {person.desc && (
              <div className="text-xs text-gray-500 mt-2">{person.desc}</div>
            )}
          </div>
        </div>
      </SwiperSlide>
